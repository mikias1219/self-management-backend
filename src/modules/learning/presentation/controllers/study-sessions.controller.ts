...
import { CreateStudySessionDto } from '../../application/dto/create-study-session.dto';
import { UpdateStudySessionDto } from '../../application/dto/update-study-session.dto';
...
export class StudySessionsController {
  ...
  @Post()
  create(@CurrentUser() user: AuthUserPayload, @Body() dto: CreateStudySessionDto) {
    return this.service.create(dto, user.sub);
  }

  @Patch(':id')
  update(@CurrentUser() user: AuthUserPayload, @Param('id') id: string, @Body() dto: UpdateStudySessionDto) {
